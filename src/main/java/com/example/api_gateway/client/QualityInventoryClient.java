...
public interface QualityInventoryClient {
    ...
    QualityResponse getQualityInspectionById(@PathVariable int id);
    @PostMapping("/qualityinspection")
    void createQualityInspection(@RequestBody QualityInspectionDto qualityInspectionDto);
    ...
    InventoryResponse getVehicleInventoryById(@PathVariable int id);
